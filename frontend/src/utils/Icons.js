...
export const history = <i className="fa-solid fa-history"></i>
export const analysis = <i class="fa-solid fa-bar-chart"></i>
export const emi = <i className="fa-solid fa-coins"></i>